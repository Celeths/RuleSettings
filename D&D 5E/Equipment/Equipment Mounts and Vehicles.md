...
A mount can help you move more quickly through the wilderness, but its primary purpose is to carry gear that would otherwise slow you down. The table shows each animal's carrying capacity. See "Monsters" for the animals' stat blocks.
...
Barding is armor designed for a mount. Any type of armor in the Armor tables in "Equipment" can be purchased as barding. The cost is four times the normal cost, and it weighs twice as much.

## Tack, Harness, and Drawn Vehicles

A saddle comes with a bit, a bridle, reins, and any other equipment needed to use the saddle. A Military Saddle gives [[Term Advantage]] on any ability check you make to remain mounted. An Exotic Saddle is required for riding an aquatic or a flying mount.
...
If a vehicle has a damage threshold (see "[[Term Rules Glossary]]"), it's noted in the table.
