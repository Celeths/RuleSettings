...
_**Standard Array.**_ Use the following six scores for your abilities: 15, 14, 13, 12, 10, 8.

_**Random Generation.**_ Roll four d6s and record the total of the highest three dice. Do this five more times, so you have six numbers.

_**Point Cost.**_ You have 27 points to spend on your ability scores. The cost of each score is shown in the table. For example, a score of 14 costs 7 of your 27 points.
...
Finally, determine your ability modifiers using this table. Write the modifier next to each of your scores.
