...
- **Friend of Dwarvenkind.** You have [[Term Advantage]] on Charisma (Persuasion) checks made to interact with dwarves and duergar.
...
- **Darkvision.** You have [[Term Darkvision]] with a range of 60 feet.
- **Resilience.** You have [[Term Resistance]] to Poison damage. You also have [[Term Advantage]] on saving throws you make to avoid or end the [[Term Poisoned]] condition.
