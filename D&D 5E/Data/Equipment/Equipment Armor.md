...
The tables list the game's main armor. The tables include the cost and weight of armor, as well as the following details:
...
- **Armor Class (AC).** The tables' [[Term Armor Class]] column tells you what your base AC is when you wear a type of armor. For example, if you wear Leather Armor, your base AC is 11 plus your Dexterity modifier, whereas your AC is 16 in Chain Mail.
...
- **Stealth.** If the table shows "[[Term Disadvantage]]" in the Stealth column for an armor type, the wearer has Disadvantage on Dexterity (Stealth) checks.
...
| Heavy Armor (10 Minutes to Don and 5 Minutes to Doff)   |   Armor Class (AC) | Strength   | Stealth      | Weight   | Cost     |
|---------------------------------------------------------|--------------------|------------|--------------|----------|----------|
...
If you wear Light, Medium, or Heavy armor and lack training with it, you have [[Term Disadvantage]] on any [[Term D20 Test]] that involves Strength or Dexterity, and you can't cast spells.

### Shield

You gain the [[Term Armor Class]] benefit of a Shield only if you have training with it.
