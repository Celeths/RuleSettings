...
- **Tags in Brackets.** Some entries have a tag in brackets after the entry's name, as in "[[Term Attack]] \[[[Term Action]]\]." A tag — Action, [[Term Area of Effect]], [[Term Attitude]], [[Term Condition]], or [[Term Hazard]] — indicates that a rule is part of a family of rules. The tags also have glossary entries.
- **"You."** The game's rules — in this glossary and elsewhere — often talk about something happening to you in the game world. That "you" refers to the creature or object that the rule applies to in a particular moment of play. For example, the "you" in the [[Term Prone]] condition is a creature that currently has that condition.
