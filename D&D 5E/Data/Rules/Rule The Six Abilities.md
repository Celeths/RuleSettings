...
Each ability has a score from 1 to 20, although some monsters have a score as high as 30. The score represents the magnitude of an ability. The table summarizes what the scores mean.
...
Each ability has a modifier that you apply whenever you make a D20 Test with that ability (explained in "[[Term D20 Test]]s"). An ability modifier is derived from its score.
