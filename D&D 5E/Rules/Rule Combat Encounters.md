...
Using the table, cross-reference the party's level with the desired encounter difficulty. Multiply the number in the table by the number of characters in the party to get your XP budget for the encounter.
...
- **Example 1.** A low-difficulty encounter for four level 1 characters has an XP budget of 50 × 4, for a total of 200 XP. With that, you could build any of the following encounters:
    - **-** 1 **[[Monster Bugbear Warrior]]** (200 XP)
    - **-** 2 **[[Monster Giant Wasp]]s** (100 XP each), for 200 XP total
    - **-** 6 **[[Monster Giant Rat]]s** (25 XP each), for 150 XP total
- **Example 2.** A moderate-difficulty encounter for five level 3 characters has an XP budget of 225 × 5, for a total of 1,125 XP. With that, you could build either of these encounters:
    - **-** 2 **[[Class Druid]]s** (450 XP each) and 9 **[[Monster Stirge]]s** (25 XP each), for 1,125 XP total
    - **-** 1 **[[Monster Wight]]** (700 XP), 1 **[[Monster Warhorse Skeleton]]** (100 XP), and 6 **[[Monster Skeleton]]s** (50 XP each), for 1,100 XP total
- **Example 3.** A high-difficulty encounter for six level 15 characters has an XP budget of 7,800 × 6, for a total of 46,800 XP. With that, you could build this encounter:
    - **-** 2 **[[Monster Adult Red Dragon]]s** (18,000 XP each) and 2 **[[Monster Fire Giant]]s** (5,000 XP each), for 46,000 XP total
...
If your combat encounter includes a creature whose CR is higher than the party's level, be aware that such a creature might deal enough damage with a single action to take out one or more characters. For example, an **[[Monster Ogre]]** (CR 2) can kill a level 1 Wizard with a single blow.

### Unusual Features

If a monster has a feature that lower-level characters can't easily overcome, consider not adding that monster to an encounter for characters whose level is lower than the monster's [[Term Challenge Rating]].
