...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 [[Term Hit Points]] per 10-foot section, and it has [[Term Immunity]] to Cold, Poison, and Psychic damage and [[Term Vulnerability]] to Fire damage. Reducing a 10-foot section of wall to 0 Hit Points destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
...
_**Using a Higher-Level Spell Slot.**_ The damage the wall deals when it appears increases by 2d6 and the damage from passing through the sheet of frigid air increases by 1d6 for each spell slot level above 6.
